...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 230, 340, -1));
        jPanel1.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 300, 340, -1));

        jLabel3.setFont(new java.awt.Font("Franklin Gothic Medium", 1, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("BaSC Library Management System");
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 350, 340, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 20, 70, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 870, 470));

        setSize(new java.awt.Dimension(886, 504));
            ...
            try (ResultSet rs = pst.executeQuery()) {
                ...
                if (rs.next()) {
                    ...
                    if ("Administrator".equalsIgnoreCase(dbRole)) {
                        Admin.Books adminDash = new Admin.Books();
                        adminDash.setVisible(true);
                    } else {
                        Students.Home operatorDash = new Students.Home();
